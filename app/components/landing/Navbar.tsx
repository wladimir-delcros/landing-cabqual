  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#0F1C35]/95 backdrop-blur-md border-b border-white/10 shadow-[0_4px_40px_rgba(0,0,0,0.4)]"
    ...
    >
      ...
      {open && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className="lg:hidden bg-[#0F1C35]/98 backdrop-blur-md border-t border-white/10 px-6 py-6"
        >
